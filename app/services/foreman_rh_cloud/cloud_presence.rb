module ForemanRhCloud
  class CloudPresence
    ...
    def register_rhc_instance
      rhc_instance_id_setting = Foreman.settings.find('rhc_instance_id')
      raise Foreman::Exception.new('rhc_instance_id is empty, cannot register RHC to the cloud') if rhc_instance_id_setting.nil? || Setting[:rhc_instance_id].empty?
